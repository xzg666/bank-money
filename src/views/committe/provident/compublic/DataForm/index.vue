  ...
  <div class="app-container">
    <el-row>
      ...
      >
        ...
        >
          <el-form-item v-if="item.show" :label="item.label" :prop="item.model">
            <el-input
    ...
    <div v-if="isBlock" style="position: absolute;bottom: 40px;">
      <el-row type="flex">
        <el-button
          type="primary"
          ...
          >保存</el-button>
        <el-button type="primary" @click="$emit('addSubmitTj')">提交</el-button>
        <el-button
          type="primary"
          :loading="btnLoad"
          @click="$emit('addSubmitProcess')"
          >发起审核</el-button>
        <el-button @click="$emit('cacleBtn')">取消</el-button>
      </el-row>
    </div>
  </div>
</template>
