...
<template>
  <div class="app-container">
    <div class="admittance">
      ...
      <div
        v-for="(detailsItem, detailsIndex) in detailsData"
        :key="detailsIndex"
      >
        <div class="info">
          <el-card
        ...
        <div
          v-if="detailsItem.tdRuleEntryTemplateList[0].entryShowType == '2'"
          class="table-box"
        >
          <div>
            <el-table :data="tableData">
              <el-table-column
                v-for="(_item, index) in yuanData[0].tdRuleEntryTemplateList[0]
  ...
  methods: {
    ...
    getDetailsData() {
      ...
      queryRuleDetail(params).then(res => {
        const data = res.data;
        // 数据适配
        data.tdRuleVersionEntryList =
          data.tdRuleVersionEntryTypeList[0].tdRuleVersionEntryList;
        delete data.tdRuleVersionEntryTypeList;
