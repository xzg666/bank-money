    ...
    <div class="admittance">
        ...
        <el-card class="box-card info-box">
          ...
          <ul>
            ...
            <li>
              ...
              <div style="display:inline-block">
                <el-date-picker
                  v-model="submitData.ruleVersionEffectiveDate"
                  type="date"
                  placeholder="选择日期"
                  format="yyyy-MM-dd"
            ...
            <li>
              ...
              <div style="display:inline-block">
                <el-date-picker
                  v-model="submitData.ruleVersionExpirationDate"
                  type="date"
                  placeholder="选择日期"
                  format="yyyy-MM-dd"
                  value-format="yyyy-MM-dd"
      ...
      <div v-for="(item, detailsIndex) in detailsData" :key="detailsIndex">
        <div class="info">
          <el-card
            v-if="
              detailsData[detailsIndex].tdRuleEntryTemplateList.length > 0 &&
          ...
          >
            ...
            <div v-for="(item, index) in stringPrarams2" :key="index">
              <el-row>
                ...
                <el-col :span="22">
                  <span
                    v-for="(citem, cindex) in item.tdRuleEntryVariableList"
                    :key="cindex"
                  >
              ...
              <div class="history-box" style="display:inline-block;float:left">
                <div>
                  ...
                  <div class="history-tit">
                    <span>{{
                        reckonItem.tdRuleEntryVariableList[0].variableEngName
                      }}
                    </span>
                  </div>
                  <div
                    v-for="(citem,
                    cindex) in reckonItem.tdRuleEntryVariableList"
                    :key="cindex"
                  >
                    <div class="test-item">
...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      this.submitData.tdRuleVersionEntryList = totalArr;
      for (let i = 0; i < this.submitData.tdRuleVersionEntryList.length; i++) {
      ...
      for (let k = 0; k < this.submitData.tdRuleVersionEntryList.length; k++) {
    ...
    addDomain(reckonItem) {
      ...
      //   value: ''
      // });
      reckonItem.tdRuleEntryVariableList.push({
        // entryTemplateId:'',
        // entryVariableId:'',
        variableChName: reckonItem.tdRuleEntryVariableList[0].variableChName,
        variableDesc: reckonItem.tdRuleEntryVariableList[0].variableDesc,
        variableEngName: reckonItem.tdRuleEntryVariableList[0].variableEngName,
        variableValue: '',
        variableOrder: reckonItem.tdRuleEntryVariableList[0].variableOrder
      });
    },
    getDetailsData() {
      const params = {
