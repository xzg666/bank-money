<template>
  <div class="container">
    ...
    <!--表单配置详情-->
    <el-dialog title="保存表单" :visible.sync="formOpen" width="500px" append-to-body>
...
//     if (formId) {
//       form_api.getFormByFormId(formId).then(res => {
...
//       }
//       this.form.vueTxt = JSON.stringify(this.formData);
//       this.formOpen = true;
//       this.formTitle = '添加表单';
//     },
//     // 确认保存表单
