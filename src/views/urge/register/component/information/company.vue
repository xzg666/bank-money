<template>
  <div>
    <el-card>
      ...
      >
        <template slot="table">
          <el-table-column label="个人账号" prop="roleName" :show-overflow-tooltip="true" width="150" />
          <el-table-column label="记账日期" prop="roleSort" width="130" />
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        name: '水天姬',
        IDNumber: '4325221993000000000'
      },
      formData: [
        { label: '姓名', model: 'name', disabled: true },
        { label: '证件号码', model: 'IDNumber', disabled: true }
      ],
