    ...
    <el-card>
      ...
      >
        <template slot="table">
          ...
          <el-table-column label="客户姓名" prop="roleName" :show-overflow-tooltip="true" width="150" />
          <el-table-column label="逾期月份" prop="roleSort" width="130" />
...
export default {
  ...
  data() {
    return {
      ...
      formData: [
        {
          label: '催收类型', model: 'urgeType', type: 'select',
          dictOptions: [
        ...
        {
          label: '催收方式', model: 'urgeMode', type: 'select',
          dictOptions: [
            { dictValue: '1', dictLabel: '12' },
            { dictValue: '2', dictLabel: '34' }
          ]
        ...
        {
          label: '催收时间', model: 'urgeTime', type: 'select',
          dictOptions: [
            { dictValue: '1', dictLabel: '12' },
            { dictValue: '2', dictLabel: '34' }
          ]
        ...
        //   ]
        // },
        { label: '开始日期', type: 'date', model: 'startDt' },
        { label: '结束日期', type: 'date', model: 'endDt' }
      ],
