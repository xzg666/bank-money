...
>导出</el-button>
      ...
      <template slot="table">
        <el-table-column label="业务流水号" prop="ywid" width="180" />
        ...
        <el-table-column label="开票状态" prop=" billresult" width="180">
          <template slot-scope="scope">
            {{
              $selectDictLabel(
                $store.getters.dictData.dzbh_kp_status || [],
                scope.row.billresult
              )
            }}
          </template>
        </el-table-column>
        ...
        />
        <el-table-column label="项目标段编号" prop="bidno" width="180" />
        <el-table-column
          label="投保企业社会统一信用代码"
          prop="tenderunifycreditcode"
          width="180"
        />
        <el-table-column
          label="提交结算时间"
        ...
        />
        <el-table-column label="担保保额(元)" prop="offeramount" width="180" />
        <el-table-column label="担保保费(元)" prop="amount" width="150" />
        <el-table-column
          label="保函申请时间"
        ...
        <el-table-column label="担保号" prop="insureorderno" width="120" />
        <el-table-column label="担保期限(天)" prop="tbyxq" width="120" />
        <el-table-column label="特别条款" prop="endorsetext" width="120" />
        <el-table-column
          label="投保企业联系人"
          prop="tenderlinkername"
          width="200"
        />

        <el-table-column
          label="投保企业联系电话"
          prop="tenderlinkermobile"
          width="150"
        />
        ...
        <el-table-column label="开标时间" prop="releasetime" width="120" />

        <el-table-column label="招标人" prop="issuename" width="180" />
        <el-table-column
          label="招标人统一社会信用代码"
          prop="issueunifycreditcode"
          width="180"
        />
        <!-- <el-table-column
          label="招标人地址"
        ...
        <el-table-column
          label="提交验证时间"
          prop="baohansubmittime"
          width="180"
        />
        <el-table-column
          label="保函受理时间"
          prop="baohanacceptancetime"
          width="180"
        />

        <el-table-column label="退保原因" prop="policyreason" width="180" />
        <!-- <el-table-column label="退保金额" prop="policyreason" width="180" /> -->
        <!-- <el-table-column label="理赔原因" prop="cliaimreason" width="180" />
        <el-table-column label="理赔金额" prop="cliaimreason" width="180" /> -->
...
import { listQuery, exportLog } from '@/api/electGuarantee/zhuzhou';
...
export default {
      ...
      listData: [
        {
          ...
          data: [
            ...
            // },
            { label: '投保企业联系人', prop: 'tenderlinkername' },
            {
              label: '投保企业社会统一信用代码',
              prop: 'tenderunifycreditcode'
            },
            { label: '项目标段编号', prop: 'bidno' },
            { label: '招标人名称', prop: 'issuename' },
            { label: '招标统一社会信用代码', prop: 'issueunifycreditcode' },
            // { label: '招标人地址', prop: 'tendereeaddress' },
            // { label: '招标人联系电话', prop: 'tendereecontactphonenumber' },
            { label: '担保保费(元)', prop: 'amount' },
            { label: '担保保额(元)', prop: 'offeramount' },
            { label: '起保日期', prop: 'startdate' },
            { label: '终保日期', prop: 'enddate' },
            { label: '担保期限(天)', prop: 'tbyxq' },
        ...
        },
        {
          ...
          data: [
            ...
            { label: '电子发票下载地址', prop: 'billdownloadurl' }
  ...
  computed: {
    formData: function(params) {
      return [
        { label: '开标起始时间', model: 'kaibiaoStartDate', type: 'datetime' },
        { label: '开标结束时间', model: 'kaibiaoEndDate', type: 'datetime' },
        {
          label: '申请开始日期',
        ...
        //   type: 'date'
        // },
        { label: '担保号', model: 'insureorderno' },
        // { label: '预担保号', model: 'preguaranteenumber' },
        { label: '业务流水号', model: 'ywid' },
        { label: '投保企业名称', model: 'tendername' },
        {
          label: '担保状态',
