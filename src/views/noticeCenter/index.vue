  ...
  <div>
    <el-table :data="tableData">
      ...
      <el-table-column align="center" label="状态" prop="createTime">
        <template slot-scope="scope">
          <p v-if="scope.row.isView===0">未读</p>
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <el-button
            v-if=" scope.row.isView===0&scope.row.txType===0"
            type="text"
    ...
    <el-dialog :visible.sync="messageDialogVisible" append-to-body width="400px">
      <el-form ref="form" :model="messageInfo" label-width="80px">
        <el-form-item label="消息内容" prop="date">
          <el-input v-model="messageInfo.msg" readonly></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="messageDialogVisible=false">保存</el-button>
